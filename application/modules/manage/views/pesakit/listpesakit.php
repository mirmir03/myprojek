...
<div class="card">
    <div class="card-header">
        ...
        <?php endif; ?>
        <!-- Graph Button -->
        <a class="btn btn-success" href="<?php echo module_url("pesakit/patient_graph"); ?>">
...
$(document).ready(function() {
    ...
    $('#input-search').on('keyup', function() {
        ...
        const rows = document.querySelectorAll('#pesakit-table tbody tr');
    ...
    // Delete button functionality - keep original logic
...
function testModal() {
    showCommentModal('Test Patient', 'Test Ref', 'Test Sub', 'This is a test comment to verify the modal is working properly.');
}

// Add this to console to test: testModal()
</script>