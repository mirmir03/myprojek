...
class Dashboard extends Admin_Controller {
	...
	{		
     ...
     // print_r($_SESSION);
      $created_by = $_SESSSION["UID"];//this one is the most important
	}
...
'COV_BANK_KOD' => strtoupper($this->input->post('cov_bank_kod')),
	...
	function csv()
	{
        ...
        public function generatepdf(){
            ...
            $this->load->library("m_pdf");//first  step
            $this->m_pdf->pdf->WriteHTML('$data');//2nd step
            $this->m_pdf->pdf->Output();//3rd step
        }
